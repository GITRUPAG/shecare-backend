...
import com.app.shecare.service.OtpService;
import com.app.shecare.service.SmsService;
...
public ResponseEntity<?> verifyOtp(@RequestBody Map<String, String> body) {
    ...
    if (phone == null || otp == null) {
        return ResponseEntity.badRequest()
                .body(Map.of("message", "Phone and OTP required"));
    }
    ...
    AuthResponse response = userService.otpLogin(phone);
