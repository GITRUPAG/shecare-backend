...
public class CommunityController {
    ...
    public CommunityPost getPostById(@PathVariable String postId) {
    ...
    public CommunityComment addComment(
        ...
        return communityService.addComment(userDetails.getUser(), postId, request);
    }
    ...
    public CommunityComment replyToComment(
        ...
        return communityService.replyToComment(userDetails.getUser(), commentId, request);
    }
    ...
    public String repost(
        ...
        return communityService.repost(userDetails.getUser(), postId);
    }

    @GetMapping("/search")
    public List<CommunityPost> searchByHashtag(@RequestParam String hashtag) {
    ...
    public String reportPost(
        ...
        return communityService.reportPost(userDetails.getUser(), postId, reason);
    }
    ...
    public String bookmarkPost(
        ...
        return communityService.bookmarkPost(userDetails.getUser(), postId);
    }
    ...
    public List<CommunityPost> getBookmarks(
        ...
        return communityService.getBookmarks(userDetails.getUser());
    }
