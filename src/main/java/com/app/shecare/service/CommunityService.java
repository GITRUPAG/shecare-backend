...
public class CommunityService {
    ...
    public CommunityComment replyToComment(User user, String commentId, CommentRequest request) {

        CommunityComment parent = commentRepository.findById(commentId)
        ...
        CommunityComment saved = commentRepository.save(reply);
    ...
    public String repost(User user, String postId) {
        ...
        var existing = repostRepository.findByPostIdAndUserId(postId, user.getId());
    ...
    public String bookmarkPost(User user, String postId) {
        var existing = bookmarkRepository.findByPostIdAndUserId(postId, user.getId());
    ...
    public List<CommunityPost> getBookmarks(User user) {
        List<CommunityBookmark> bookmarks = bookmarkRepository.findByUserId(user.getId());
    ...
    public List<CommunityPost> getTrendingPosts(int page) {
        Pageable pageable = PageRequest.of(page, 10);
        return postRepository.findAllByOrderByScoreDescCreatedAtDesc(pageable);
    }
