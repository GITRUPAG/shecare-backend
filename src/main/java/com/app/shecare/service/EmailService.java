...
public void sendSosAlertEmail(
    ...
    sendEmail(
        toEmail,
        "🚨 SHEcare Emergency Alert — " + userName + " needs help!",
        buildSosAlertEmailHtml(contactName, userName, voiceMessage,
                               mapsLink, batteryLevel, timestamp)
    );
}

private String buildSosAlertEmailHtml(
        String contactName,
        String userName,
        String voiceMessage,
        String mapsLink,
    ...
    String displayContact = (contactName != null) ? contactName : "there";
    String displayMessage = (voiceMessage != null) ? voiceMessage : "I am in danger";
    String displayBattery = (batteryLevel != null) ? batteryLevel + "%%" : "Unknown";
    ...
    return """
        ...
        <head>
          <meta charset="UTF-8"/>
          <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
          <title>SHEcare Emergency Alert</title>
        </head>
        <body style="margin:0;padding:0;background:#F9F0F5;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
          <table width="100%%" cellpadding="0" cellspacing="0" style="background:#F9F0F5;padding:40px 0;">
            <tr><td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%%;">
                ...
                <tr>
                  <td style="background:linear-gradient(135deg,#D85E82 0%%,#80468E 100%%);border-radius:20px 20px 0 0;padding:40px;text-align:center;">
                    ...
                    <h1 style="margin:0;font-size:28px;font-weight:700;color:#ffffff;">Emergency Alert</h1>
                    <p style="margin:8px 0 0;font-size:14px;color:rgba(255,255,255,0.80);">SHEcare Safety System</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background:#ffffff;padding:40px 48px;">
                    ...
                    <p style="margin:0 0 20px;font-size:16px;color:#2D1040;">
                      Hi <strong>%s</strong>,
                    </p>

                    <div style="background:#FFF0F3;border:2px solid #D85E82;border-radius:14px;padding:24px;margin-bottom:28px;text-align:center;">
                      <p style="margin:0 0 6px;font-size:18px;font-weight:700;color:#D85E82;">
                        %s needs your help right now!
                      </p>
                      <p style="margin:0;font-size:15px;color:#80468E;font-style:italic;">
                        "%s"
                      </p>
                    </div>
                    ...
                    <table width="100%%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                      <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #F0D8E8;">
                          <span style="font-size:20px;">📍</span>
                          <span style="font-size:14px;color:#603377;font-weight:600;margin-left:10px;">Location</span>
                        </td>
                        <td style="padding:10px 0;border-bottom:1px solid #F0D8E8;text-align:right;">
                          <a href="%s" style="color:#D85E82;font-weight:700;font-size:14px;text-decoration:none;">
                            Open in Google Maps →
                          </a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #F0D8E8;">
                          <span style="font-size:20px;">🔋</span>
                          <span style="font-size:14px;color:#603377;font-weight:600;margin-left:10px;">Battery Level</span>
                        </td>
                        <td style="padding:10px 0;border-bottom:1px solid #F0D8E8;text-align:right;">
                          <span style="font-size:14px;color:#2D1040;font-weight:700;">%s</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:10px 0;">
                          <span style="font-size:20px;">🕐</span>
                          <span style="font-size:14px;color:#603377;font-weight:600;margin-left:10px;">Time</span>
                        </td>
                    ...
                    <div style="text-align:center;margin-bottom:28px;">
                      <a href="%s"
                         style="display:inline-block;background:linear-gradient(135deg,#D85E82,#80468E);
                                color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;
                                padding:16px 40px;border-radius:50px;
                                box-shadow:0 8px 24px rgba(216,94,130,0.40);">
                        📍 View Her Location Now →
                      </a>
                    </div>

                    <div style="background:#FFF5F8;border-left:4px solid #D85E82;border-radius:8px;padding:16px 20px;">
                      <p style="margin:0;font-size:13px;color:#9A70A8;line-height:1.6;">
                        ⚠️ If you cannot reach her, please call emergency services immediately at <strong>112</strong>.
                      </p>
                    </div>
                ...
                <tr>
                  <td style="background:#2D1040;border-radius:0 0 20px 20px;padding:28px 40px;text-align:center;">
                    <p style="margin:0 0 8px;font-size:13px;color:#9A70A8;">
                      This alert was sent via <strong style="color:#D85E82;">SHEcare</strong> Safety System
                    </p>
                    <p style="margin:0;font-size:12px;color:#6B4080;">© 2026 SheCare · Built with 💗 for women everywhere</p>
                  </td>
                </tr>
        ...
        """.formatted(
            displayContact, userName, displayMessage,
            mapsLink, displayBattery, timestamp,
            mapsLink
        );
}
